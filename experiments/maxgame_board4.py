...
# volle kolom 14 HARD = stationsentrees (rest-zak-goedkoopste, kruist ankers op s/s/s)
COL14 = 'stationsentrees'
for y in range(H):
    m.add(cells[(14, y)].letter[cba[COL14[y]]] == 1)
...
if st in (cp_model.OPTIMAL, cp_model.FEASIBLE):
    ...
    json.dump({'grid': grid}, open('experiments/results/maxgame_board4.json','w'))
    # LB
