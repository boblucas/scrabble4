...
het 4751-punten-recordspel, de bewezen-optimale Nederlandse 2102-beurt én de bewezen-optimale Engelse (NWL) 1786-beurt.
...
2. **Maxgame**: wat is de hoogst mogelijke totaalscore van een volledig legaal gespeeld spel
   ...
   → **4751 punten, huidig record** (letterinvulling bewezen optimaal per voetafdruk via CP-SAT) (volledig bereikbare zetreeks, onafhankelijk geverifieerd).
   Zie [`experiments/MAXGAME_FINDINGS.md`](experiments/MAXGAME_FINDINGS.md) voor het volledige
   verslag (3974 → 4751, alle hefbomen en negatieve resultaten) en
